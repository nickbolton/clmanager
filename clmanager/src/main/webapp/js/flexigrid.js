	...
	$.addFlex = function(t,p)
	{
		...
		var g = {
			...
			dragStart: function (dragtype,e,obj) { //default drag function start
				...
				if (p.resizeCol && dragtype=='colresize') //column resize
					{
					 ...
					 function(i,row) 
					 	{
							...
							$(tbody).append(tr);
							if (p.onRowAdded) p.onRowAdded(tr);
							tr = null;
						}
					);				
							...
							.click(
								function (e) 
									{ 
										...
										if (p.singleRowSelection && g.selectedRow) {
											g.selectedRow.toggleClass('trSelected');
										}
										$(this).toggleClass('trSelected');
										g.selectedRow = $(this);
										if (p.onSelectRow) p.onSelectRow(this);
									}
							)
							.mousedown(
								function (e)
