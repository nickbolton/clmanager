 ...
 */
public class ReflectedImage2 extends AbstractBoundWidget implements SourcesMouseEvents {
    private Image base;
    ...
    public ReflectedImage2(String url, final int baseWidth,
    ...
    public ReflectedImage2( final int baseWidth,
            final int baseHeight, final double reflectHeight, final double opacity) {
        this.base = new Image();
        this.base.addLoadListener(new LoadListener() {
            public void onLoad(Widget sender) {
