...
public class AppEvents {
    ...
    public static final int ViewPost = 16;
    public static final int ClearReplyPending = 17;
    public static final int PostReplied = 18;
    public static final int PostReplyFailed= 19;
    public static final int UpdatePost= 20;
    
    public static final int NavPhotos = 30;
